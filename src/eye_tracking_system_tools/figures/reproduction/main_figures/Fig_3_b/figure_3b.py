"""
Reproduction script for Figure 3b: Eye angle dynamics for 30 seconds during an active period.
...
def main():
    """Main function to reproduce Figure 3b."""
    # Get the directory of this script
    script_dir = Path(__file__).parent
    
    # Load the pickle data
    pickle_file = script_dir / "figure_3b.pickle"
    output_path = script_dir / "figure_3b.pdf"
    
    try:
        with open(pickle_file, "rb") as f:
            data = pickle.load(f)
        print(f"Loaded data for {data.get('figure_name', 'figure_3b')}")
    ...
    print("Figure 3b reproduction complete!")
